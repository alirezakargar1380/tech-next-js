...
export default class ActivitySliderItem extends React.Component {
    render() {
        return (
            <div className="hh owlElement h-100">
                <div className="item borderLeft h-100">
                    <div>
                        <header className="font-blod text-right pr-4 pt-3">#{this.props.id}</header>
                        <div className="rotateAnimation svgC text-center w-100 fillColor">
                            {this.props.img}
                            {/*<svg strokeWidth="2" id="Layer_1" height="280" width="280" className="w-100" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">*/}
                        ...
                        <div className="textBoxC">
                            <h5 className="text-right mt-4 pr-4 font-blod">{this.props.title}</h5>
                            <div className="font-light font-14 text-right pr-4 pl-4 mt-3"
                                 style={{height: "90px"}}
                            >{this.props.dis}</div>
                            <MoreBtn
                                href={"/"}
                                last={"بیشتر"}
                                class={"justify-content-end pl-4 ml-2 pb-4 pt-2"}/>
                        </div>
                    </div>
